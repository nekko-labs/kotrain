# Contributing to Nekkos

Thanks for your interest! Nekkos is an open-source, local-first AI coding & cowork desktop app. Contributions of all sizes are welcome.
...
## Publishing the `npx nekkos` package
...
After that, anyone can run the web edition with `npx nekkos`.
