...
const BG = Jimp.rgbaToInt(20, 20, 26, 255); // Nekkos dark #14141a
...
side.print(f32, 0, 158, { text: 'Nekkos', alignmentX: Jimp.HORIZONTAL_ALIGN_CENTER }, 164);
