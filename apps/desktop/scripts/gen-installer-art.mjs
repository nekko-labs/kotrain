...
const BG = Jimp.rgbaToInt(20, 20, 26, 255); // Kotrain dark #14141a
...
side.print(f32, 0, 158, { text: 'Kotrain', alignmentX: Jimp.HORIZONTAL_ALIGN_CENTER }, 164);
...
header.print(f14, 54, 18, 'Kotrain');
