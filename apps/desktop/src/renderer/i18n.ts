...
const en: Dict = {
  ...
  'settings.mascot': 'Show Aphelion mascot',
...
const es: Dict = {
  ...
  'settings.mascot': 'Mostrar la mascota Aphelion',
...
const fr: Dict = {
  ...
  'settings.mascot': 'Afficher la mascotte Aphelion',
...
const de: Dict = {
  ...
  'settings.mascot': 'Aphelion-Maskottchen anzeigen',
...
const pt: Dict = {
  ...
  'settings.mascot': 'Mostrar o mascote Aphelion',
  'settings.language': 'Idioma',
...
const ja: Dict = {
  ...
  'settings.mascot': 'Aphelion マスコットを表示',
...
const zh: Dict = {
  ...
  'settings.theme': '主题',
  'settings.accent': '强调色',
  'settings.mascot': '显示 Aphelion 吉祥物',
