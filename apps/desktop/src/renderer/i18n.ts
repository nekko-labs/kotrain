...
const en: Dict = {
  ...
  'settings.mascot': 'Show Nekkos mascot',
...
const es: Dict = {
  ...
  'settings.mascot': 'Mostrar la mascota Nekkos',
...
const fr: Dict = {
  ...
  'settings.mascot': 'Afficher la mascotte Nekkos',
...
const de: Dict = {
  ...
  'settings.mascot': 'Nekkos-Maskottchen anzeigen',
...
const pt: Dict = {
  ...
  'settings.mascot': 'Mostrar o mascote Nekkos',
  'settings.language': 'Idioma',
...
const ja: Dict = {
  ...
  'settings.mascot': 'Nekkos マスコットを表示',
